...
import React7, { useCallback, useEffect } from "react";
...
var StepperDialog = ({
  ...
  useEffect(() => {
    var steps2 = document.getElementsByClassName("axis-Step");
    if (steps2) {
      if (steps2.length > 0 && steps2[currentStep] !== void 0) {
        steps2[currentStep].scrollIntoView();
      }
    }
  }, [currentStep]);
  return /* @__PURE__ */ React7.createElement("div", { className: rootStyles }, /* @__PURE__ */ React7.createElement("div", { className: containerStyles }, /* @__PURE__ */ React7.createElement("div", { className: "lungbeat-dialog-stepper-container", style: { width: "100%", overflowX: "auto" } }, /* @__PURE__ */ React7.createElement(
    Stepper,
    {
      currentStep,
      steps,
